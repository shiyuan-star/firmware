...
static void button_press_up_cb(void *arg, void *data)
{
    ...
    ESP_LOGI(TAG, "BTN%d: BUTTON_PRESS_UP[%ld]", get_btn_index((button_handle_t)arg), iot_button_get_ticks_time((button_handle_t)arg));
}
...
static void button_long_press_hold_cb(void *arg, void *data)
{
    ...
    ESP_LOGI(TAG, "BTN%d: BUTTON_LONG_PRESS_HOLD[%ld],count is [%d]", get_btn_index((button_handle_t)arg), iot_button_get_ticks_time((button_handle_t)arg), iot_button_get_long_press_hold_cnt((button_handle_t)arg));
}
