...
SemaphoreHandle_t g_ledstripRmtHandleMetex; // LED灯带句柄互斥信号量(灯带刷新需要保持RMT资源互斥)
...
NvsData_t g_defaultNvsData = {
    ...
    .networkConfigData = {
        ...
        .otaConfigData = {
            ...
            .esp32OtaServer = DEFAULT_ESP32_OTA_SERVER_URL,
            .firmwareFileName = DEFAULT_ESP32_OTA_FILEWARE_FILE_NAME,}             
        },
    .DeviceConfigData = {
        .ledstripConfigData = {
            ...
            .pixelFormat = DEAFULT_LED_STRIP_PIXEL_FORMAT,
            .btightness = DEAFULT_LED_STRIP_BTIGHTNESS},
        .rs485ConfigData = {
             .rs485Enabled = DEAFULT_RS485_ENABLE,
             .baudrate = DEAFULT_RS485_BAUDRATE,
             .slaveNum = DEAFULT_RS485_SLAVE_NUM,
             .slaveModel = DEAFULT_RS485_SLAVE_MODEL,}
        },   
    .projectConfigData = {
