...
// 宏定义
#define FIRMWARE_VERSION "V0.0.2" // 固件版本名
#define NETWORK_NVS_DATA_OVERWRITE false   // 更新固件用default_config覆写网络存储的配置
#define DEVICE_NVS_DATA_OVERWRITE true    // 覆写外设存储的配置
