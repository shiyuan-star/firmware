...
const cjsonx_reflect_t OtaConfigData_reflection[] = {
    ...
    __cjsonx_str(OtaConfigData_t, esp32OtaServer),
    __cjsonx_str(OtaConfigData_t, firmwareFileName),
    __cjsonx_end()};
...
const cjsonx_reflect_t LedstripConfigData_reflection[] = {
    ...
    __cjsonx_int(LedstripConfigData_t, pixelFormat),
    __cjsonx_int(LedstripConfigData_t, btightness),
    __cjsonx_end()
};

const cjsonx_reflect_t rs485ConfigData_reflection[] = {
    __cjsonx_bool(RS485ConfigData_t, rs485Enabled),
    __cjsonx_int(RS485ConfigData_t, baudrate),
    __cjsonx_int(RS485ConfigData_t, slaveNum),
    __cjsonx_int(RS485ConfigData_t, slaveModel),
    __cjsonx_end()};
...
const cjsonx_reflect_t DeviceConfigData_reflection[] = {
    ...
    __cjsonx_object_ex(DeviceConfigData_t, rs485ConfigData, rs485ConfigData_reflection, __serialized(true)),
    __cjsonx_end()};
